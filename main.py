...
for i in range(1):
    ...
    print("Read all BNs. Time elapsed: %s", (time.perf_counter() - start))
    ...
    for bn in BN:
        ...
        print("Read Charity JSON. Time elapsed: %s", (time.perf_counter() - start))
        ...
        print("Read Charity finances JSON. Time elapsed: %s", (time.perf_counter() - start))
    ...
    print("Wrote to CSV. Time elapsed: %s", (time.perf_counter() - start))    
